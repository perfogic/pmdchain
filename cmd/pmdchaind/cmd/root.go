...
func (a appCreator) appExport(
	...
	if height != -1 {
		pmdApp = app.New(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := pmdApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		pmdApp = app.New(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return pmdApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
